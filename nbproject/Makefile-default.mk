...
FINAL_IMAGE=${DISTDIR}/LAB6_PuC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}
else
...
SOURCEFILES_QUOTED_IF_SPACED=mainL6.s macros.s

# Object Files Quoted if spaced
OBJECTFILES_QUOTED_IF_SPACED=${OBJECTDIR}/mainL6.o ${OBJECTDIR}/macros.o
POSSIBLE_DEPFILES=${OBJECTDIR}/mainL6.o.d ${OBJECTDIR}/macros.o.d

# Object Files
OBJECTFILES=${OBJECTDIR}/mainL6.o ${OBJECTDIR}/macros.o

# Source Files
SOURCEFILES=mainL6.s macros.s
...
ifneq ($(INFORMATION_MESSAGE), )
	...
	${MAKE}  -f nbproject/Makefile-default.mk ${DISTDIR}/LAB6_PuC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}

MP_PROCESSOR_OPTION=PIC16F887
FINAL_IMAGE_NAME_MINUS_EXTENSION=${DISTDIR}/LAB6_PuC.X.${IMAGE_TYPE}
# ------------------------------------------------------------------------------------
# Rules for buildStep: pic-as-assembler
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${OBJECTDIR}/mainL6.o: mainL6.s  nbproject/Makefile-${CND_CONF}.mk 
	@${MKDIR} "${OBJECTDIR}" 
	@${RM} ${OBJECTDIR}/mainL6.o 
	${MP_AS} -mcpu=PIC16F887 -c \
	-o ${OBJECTDIR}/mainL6.o \
	mainL6.s \
...
ifeq ($(TYPE_IMAGE), DEBUG_RUN)
${DISTDIR}/LAB6_PuC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX}: ${OBJECTFILES}  nbproject/Makefile-${CND_CONF}.mk    
	@${MKDIR} ${DISTDIR} 
	${MP_LD} -mcpu=PIC16F887 ${OBJECTFILES_QUOTED_IF_SPACED} \
	-o ${DISTDIR}/LAB6_PuC.X.${IMAGE_TYPE}.${OUTPUT_SUFFIX} \
